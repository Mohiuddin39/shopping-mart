...
const BannerText = ({ title }: props) => {
  return (
    <div className="hidden lg:inline-block w-full h-full absolute top-0 left-0">
      <Container className=" flex h-full flex-col gap-y-6 justify-center">
        ...
        >
          <button className="py-3 px-6 rounded-full bg-slate-200 hover:bg-white duration-200 text-sm font-semibold">
            FIND OUT MORE
          </button>
          <button className="py-3 px-6 rounded-full bg-slate-200 hover:bg-white duration-200 text-sm font-semibold">
            SHOP NOW
